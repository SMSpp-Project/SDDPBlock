...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
 /// set the vector-of-int parameters of SDDPSolver
 /** Set a given vector-of-int parameter. Besides considering the vector-of-int
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
 /// set the vector-of-double parameters of SDDPSolver
